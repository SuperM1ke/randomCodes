import unittest
from custom_errors import RunnerAlreadyExistsError, RunnerDoesntExistError, RaceIsFullError, CustomValueError, CustomTypeError
...
class TestRaces(unittest.TestCase):
    ...
    def test_add_runner(self):
        ...
        with self.assertRaises(RaceIsFullError):
            short_race.add_runner(Runner('overadd runner', 10, 'Azerbaijan', 3.2, 2.2))
    ...
    def test_remove_runner(self):
        ...
        # test removing an non_exist Runner
